...
if(isset($_POST['submit']))
{
    ...
    $sl;
		...
		// Sua Chỗ Này
		echo "<script>window.location.replace('http://localhost/Ban/Ban/dogiadung/cart.php'); </script>";
}
							...
							<div class="caption">
								...
								<div class="info">
									<ul>
										...
										<li><a href="/category.php?manhasx=<?php echo $row["Manhasx"]?>"><?php echo $row["Tennhasx"]?></a> <h3></li>
									</ul>
								</div>
								<?php
